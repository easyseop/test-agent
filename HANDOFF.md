...
> 유닛 테스트 **557개 통과** (커밋·브랜치는 훅이 매 턴 실측 주입 — 문서 값은 참고용)
...
python3 -m pytest tests/ -q                     # 557 passed 여야 정상
```
...
```bash
python3 -m pytest tests/ -q                              # 557 passed
